# Download the CIFAR-100 dataset so it can be used for training, from huggingface because original slow
...
if os.path.exists(dataset_path):
    ...
    print("From https://huggingface.co/datasets/uoft-cs/cifar100")
    ...
    for i in range(len(ds["train"])):
        ...
        train_csv.write(image_name + "," + str(item["fine_label"]) + "\n")
    ...
    for i in range(len(ds["test"])):
        ...
        test_csv.write(image_name + "," + str(item["fine_label"]) + "\n")
